package com.aarcsx.krisho.features.legal
...
fun HelpCenterScreen(onBackClick: () -> Unit) {
    LegalScreen(
        title = "Help Center",
        content = "Welcome to Krisho Help Center.\n\n" +
...
fun PrivacyPolicyScreen(onBackClick: () -> Unit) {
    LegalScreen(
        ...
        content = "Your privacy is important to us. Krisho collects minimum data required for crop diagnosis and history tracking.\n\n" +
...
fun TermsOfServiceScreen(onBackClick: () -> Unit) {
    LegalScreen(
        ...
        content = "By using Krisho, you agree to these terms:\n\n" +
