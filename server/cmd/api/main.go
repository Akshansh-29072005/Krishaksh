...
import (
	...
	adminHandler "github.com/aarcsx/krishaksh-backend/internal/modules/admin/handler"
	adminRepo "github.com/aarcsx/krishaksh-backend/internal/modules/admin/repository"
	adminRoutes "github.com/aarcsx/krishaksh-backend/internal/modules/admin/routes"
	adminService "github.com/aarcsx/krishaksh-backend/internal/modules/admin/service"
	adHandler "github.com/aarcsx/krishaksh-backend/internal/modules/advertisements/handler"
	adRepo "github.com/aarcsx/krishaksh-backend/internal/modules/advertisements/repository"
	adRoutes "github.com/aarcsx/krishaksh-backend/internal/modules/advertisements/routes"
	analyticsHandler "github.com/aarcsx/krishaksh-backend/internal/modules/analytics/handler"
	analyticsRepo "github.com/aarcsx/krishaksh-backend/internal/modules/analytics/repository"
	analyticsRoutes "github.com/aarcsx/krishaksh-backend/internal/modules/analytics/routes"
	analyticsService "github.com/aarcsx/krishaksh-backend/internal/modules/analytics/service"
	authHandler "github.com/aarcsx/krishaksh-backend/internal/modules/auth/handler"
	authRepo "github.com/aarcsx/krishaksh-backend/internal/modules/auth/repository"
	authRoutes "github.com/aarcsx/krishaksh-backend/internal/modules/auth/routes"
	authService "github.com/aarcsx/krishaksh-backend/internal/modules/auth/service"
	cartHandler "github.com/aarcsx/krishaksh-backend/internal/modules/cart/handler"
	cartRepo "github.com/aarcsx/krishaksh-backend/internal/modules/cart/repository"
	cartRoutes "github.com/aarcsx/krishaksh-backend/internal/modules/cart/routes"
	cartService "github.com/aarcsx/krishaksh-backend/internal/modules/cart/service"
	companyHandler "github.com/aarcsx/krishaksh-backend/internal/modules/company/handler"
	companyRoutes "github.com/aarcsx/krishaksh-backend/internal/modules/company/routes"
	companyService "github.com/aarcsx/krishaksh-backend/internal/modules/company/service"
	diseaseHandler "github.com/aarcsx/krishaksh-backend/internal/modules/diseases/handler"
	diseaseRepo "github.com/aarcsx/krishaksh-backend/internal/modules/diseases/repository"
	diseaseRoutes "github.com/aarcsx/krishaksh-backend/internal/modules/diseases/routes"
	orderHandler "github.com/aarcsx/krishaksh-backend/internal/modules/orders/handler"
	orderRepo "github.com/aarcsx/krishaksh-backend/internal/modules/orders/repository"
	orderRoutes "github.com/aarcsx/krishaksh-backend/internal/modules/orders/routes"
	orderService "github.com/aarcsx/krishaksh-backend/internal/modules/orders/service"
	paymentHandler "github.com/aarcsx/krishaksh-backend/internal/modules/payments/handler"
	razorpayClient "github.com/aarcsx/krishaksh-backend/internal/modules/payments/razorpay"
	paymentRepo "github.com/aarcsx/krishaksh-backend/internal/modules/payments/repository"
	paymentRoutes "github.com/aarcsx/krishaksh-backend/internal/modules/payments/routes"
	paymentService "github.com/aarcsx/krishaksh-backend/internal/modules/payments/service"
	productHandler "github.com/aarcsx/krishaksh-backend/internal/modules/products/handler"
	productRepo "github.com/aarcsx/krishaksh-backend/internal/modules/products/repository"
	productRoutes "github.com/aarcsx/krishaksh-backend/internal/modules/products/routes"
	recHandler "github.com/aarcsx/krishaksh-backend/internal/modules/recommendations/handler"
	recRoutes "github.com/aarcsx/krishaksh-backend/internal/modules/recommendations/routes"
	recService "github.com/aarcsx/krishaksh-backend/internal/modules/recommendations/service"
	scanHandler "github.com/aarcsx/krishaksh-backend/internal/modules/scans/handler"
	scanRepo "github.com/aarcsx/krishaksh-backend/internal/modules/scans/repository"
	scanRoutes "github.com/aarcsx/krishaksh-backend/internal/modules/scans/routes"
	scanService "github.com/aarcsx/krishaksh-backend/internal/modules/scans/service"
	userHandler "github.com/aarcsx/krishaksh-backend/internal/modules/users/handler"
	userRoutes "github.com/aarcsx/krishaksh-backend/internal/modules/users/routes"
...
func main() {
	...
	log.Printf("Starting Krishaksh API Server on :%s", cfg.ServerPort)
